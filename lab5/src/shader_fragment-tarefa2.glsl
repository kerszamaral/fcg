...
void main()
{
    ...
    // After a lot of testing, the following gives the most similar result
    // to the original gif.
    float night_blend = 1.0 - smoothstep(0.0, 0.1, lambert);
    color.rgb = Kd0 * (lambert + 0.01) + Kd1 * night_blend;
